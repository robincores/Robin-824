 ...
 */
public final class Vpu4_1DemoTextHwScrollMain extends Application {
    ...
    public void start(Stage stage) {
        ...
        stage.setTitle("VPU v4.1 Text HW Scroll Demo — TX_ORIGIN ring buffer");
        ...
        VPU_v4_1 vpu = new VPU_v4_1(DISPLAY_CONFIG, cpu, EXTERNAL_INTERRUPT_MASK, canvas);
    ...
    private void runDemoLoop(VPU_v4_1 vpu, TerminalHwScroll term, int cyclesPerFrame) {
        int n = 1;
    ...
    private static final class TerminalHwScroll {
        ...
        TerminalHwScroll(VPU_v4_1 vpu, int fg, int bg) {
            this.vpu = vpu;
            setColor(fg, bg);
            setOrigin(0);
            setCursor(0, 0);
